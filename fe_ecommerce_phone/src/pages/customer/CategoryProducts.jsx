...
import apiCategory from "../../api/apiCategory"; // Đảm bảo import đúng đường dẫn
...
import "../../assets/toast-custom.css"; // Đảm bảo file CSS này tồn tại

const CategoryProducts = () => {
    const { id } = useParams();
    const { setCartCounter } = useContext(AppContext); // Lấy setCartCounter từ context
